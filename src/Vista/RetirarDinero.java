...
import static Vista.IngresarDinero.convert;
...
public class RetirarDinero extends javax.swing.JFrame {
    ...
    public RetirarDinero(Usuario usr) {
        this.usr = usr;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!c.equals(usr.returnContr())) {
            JOptionPane.showMessageDialog(null, "Contraseña incorrecta");
            return;
        }
        long valor = Long.parseLong(a);
        Transaccion t = new Transaccion("Caja Laboral", sqlDate, "retirada", valor, usr.returnDNI(), usr);
        t.nuevaTransaccion();
        this.dispose();
